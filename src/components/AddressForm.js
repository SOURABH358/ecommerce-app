...
export default function AddressForm() {
    return <section className="w-full min-h-[100vh] pt-8">
        ...
        <div className="w-full md:bg-light-grey py-[2rem] md:pt-[4rem]">
            <div className="md:w-[31.25rem] md:mx-auto w-full px-4 bg-[white] py-10 md:shadow-2xl  rounded-xl">
                <p className="text-2xl font-bold mb-4">Add Shipping Address</p>
                <input type="text" placeholder="Fullname (Required)*" className="w-full border-2 border-purple mb-8 py-2 px-2 rounded-md" />
                <input type="text" placeholder="Phone Number (Required)*" className="w-full border-2 border-purple mb-8 py-2 px-2 rounded-md" />
                <div className="grid grid-cols-2 gap-x-4">
                    <input type="number" placeholder="Pincode (Required)*" className="w-full border-2 border-purple mb-8 py-2 px-2 rounded-md" />
                    <input type="text" placeholder="Country (Required)*" className="w-full border-2 border-purple mb-8 py-2 px-2 rounded-md" />
                    ...
                    <input type="text" placeholder="City (Required)*" className="w-full border-2 border-purple mb-8 py-2 px-2 rounded-md" />
                </div>
                <input type="text" placeholder="House No., Building Name (Required)*" className="w-full border-2 border-purple mb-8 py-2 px-2 rounded-md" />
